...
class DatabaseMysqlConfigArgs:
    ...
    def _configure(
        ...
        if 'backupHour' in kwargs:
            backup_hour = kwargs['backupHour']
        if 'backupMinute' in kwargs:
            backup_minute = kwargs['backupMinute']
        if 'binlogRetentionPeriod' in kwargs:
        ...
        if 'groupConcatMaxLen' in kwargs:
        ...
        if 'internalTmpMemStorageEngine' in kwargs:
            internal_tmp_mem_storage_engine = kwargs['internalTmpMemStorageEngine']
        if 'longQueryTime' in kwargs:

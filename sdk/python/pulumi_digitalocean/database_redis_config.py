...
class DatabaseRedisConfigArgs:
    ...
    def _configure(
        ...
        if 'numberOfDatabases' in kwargs:
            number_of_databases = kwargs['numberOfDatabases']
        if 'pubsubClientOutputBufferLimit' in kwargs:
